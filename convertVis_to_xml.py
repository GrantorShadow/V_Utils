...
input_img_folder = 'VisDrone2019-DET-val/images'
input_ann_folder = 'VisDrone2019-DET-val/annotations'
output_ann_folder = 'VisDrone2019-DET-val/annotations_new'
output_img_folder = 'VisDrone2019-DET-val/images_new'

# scale = 2  # PROBABLY USELESS
sizing = 1280  # scale image to this value
...
def upscale_img(sizing, img):
	...
	up_scaled_img, x_scale, y_scale = img, 1, 1
